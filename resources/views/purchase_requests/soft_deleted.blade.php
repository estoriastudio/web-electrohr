...
@section('page_title', 'Solicitudes de Compra — Papelera')
    ...
    <div class="col-xl-12">
        <div class="card border-danger">
            <div class="card-header d-flex justify-content-between align-items-center border-bottom bg-danger-subtle">
                <div>
                    <h4 class="card-title mb-0 text-danger">
                        <i class="ri-delete-bin-line me-2"></i>Papelera — SOLCOM eliminadas
                    </h4>
            ...
            <div class="card-body border-bottom py-3">
                <form method="GET" action="{{ route('purchase_requests.soft_deleted') }}" class="row g-2 align-items-end">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3 d-flex gap-1">
                        ...
                        @if ($search)
                            <a href="{{ route('purchase_requests.soft_deleted') }}" class="btn btn-outline-secondary btn-sm" title="Limpiar filtros">
