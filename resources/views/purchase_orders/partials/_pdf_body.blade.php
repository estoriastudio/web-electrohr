        ...
        <tr>
            ...
            <td width="45%" style="padding: 0;">
                <table width="100%" cellpadding="5" cellspacing="0" border="1" class="section">
                    ...
                    <tr>
                        <td style="border: 1px solid #999; padding: 5px; font-weight: bold; background-color: #f0f0f0;">ISR ({{ rtrim(rtrim(number_format((float) $po->isr_rate, 4), '0'), '.') }}%)</td>
                    ...
                    <tr>
                        <td style="border: 1px solid #999; padding: 5px; font-weight: bold; background-color: #f0f0f0;">Retenciones IVA ({{ rtrim(rtrim(number_format((float) $po->retention_iva_rate, 4), '0'), '.') }}%)</td>
                    ...
                    <tr>
                        <td style="border: 1px solid #999; padding: 5px; font-weight: bold; background-color: #f0f0f0;">Retenciones ISR ({{ rtrim(rtrim(number_format((float) $po->retention_isr_rate, 4), '0'), '.') }}%)</td>
