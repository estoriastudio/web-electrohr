@php
    ...
    $lugarEntrega = $po->workRelation?->address ?? $po->projectRelation?->address ?? $po->site ?? '—';
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
    ...
    <tr>
        <td style="padding: 0;">
            <table width="100%" cellpadding="4" cellspacing="0" border="1" style="border-collapse: collapse; border-color: #999;">
                <tr>
                    <!-- Logo -->
    ...
    <tr>
        <td style="padding: 0;">
            <table width="100%" cellpadding="4" cellspacing="0" border="1" style="border-collapse: collapse; border-color: #999; margin-top: -1px;">
                <tr>
    ...
    <tr>
        <td style="padding: 0;">
            <table width="100%" cellpadding="5" cellspacing="0" border="1" style="border-collapse: collapse; border-color: #999; margin-top: -1px;">
                <!-- Encabezados -->
                ...
                <!-- Filas de conceptos (loop en Laravel) -->
                ...
                @endforelse
                <!-- Filas vacías de relleno (opcional, para dar altura) -->
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: -1px;">
                <tr>
                    ...
                    <td width="45%" style="padding: 0;">
                        <table width="100%" cellpadding="5" cellspacing="0" border="1" style="border-collapse: collapse; border-color: #999;">
                            <tr>
    ...
    <tr>
        <td style="padding: 0;">
            <table width="100%" cellpadding="6" cellspacing="0" border="1" style="border-collapse: collapse; border-color: #999; margin-top: 10px;">
                <tr>
    ...
    <tr>
        <td style="padding: 0;">
            <table width="100%" cellpadding="10" cellspacing="0" border="1" style="border-collapse: collapse; border-color: #999;">
                <tr>
                    <!-- Firma 1 -->
