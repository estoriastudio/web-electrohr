            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label for="bank_name" class="form-label fw-medium">Banco</label>
                            <input type="text"
                        ...
                        <div class="col-12">
                            <label for="bank_account" class="form-label fw-medium">Número de cuenta</label>
                            <input type="text"
                        ...
                        <div class="col-12">
                            <label for="bank_clabe" class="form-label fw-medium">CLABE interbancaria</label>
                            <input type="text"
                                   class="form-control @error('bank_clabe') is-invalid @enderror"
                                   id="bank_clabe" name="bank_clabe"
                                   value="{{ old('bank_clabe', $supplier->bank_clabe) }}"
                                   maxlength="18">
                            @error('bank_clabe')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            <label for="swift_code" class="form-label fw-medium">Código SWIFT</label>
                            <input type="text"
                                   class="form-control @error('swift_code') is-invalid @enderror"
                                   id="swift_code" name="swift_code"
                                   value="{{ old('swift_code', $supplier->swift_code) }}"
                                   maxlength="11"
                                   style="text-transform: uppercase;">
                            @error('swift_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-select @error('currency') is-invalid @enderror"
                                ...
                                <option value="MXN" {{ old('currency', $supplier->currency) === 'MXN' ? 'selected' : '' }}>MXN — Peso mexicano</option>
                                <option value="USD" {{ old('currency', $supplier->currency) === 'USD' ? 'selected' : '' }}>USD — Dólar estadounidense</option>
