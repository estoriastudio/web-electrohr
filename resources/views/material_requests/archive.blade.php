...
@section('page_title', 'SOLMAT — Archivadas')
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                <div>
                    <h4 class="card-title mb-0">
                        <i class="ri-archive-line me-2 text-muted"></i>SOLMATs archivadas
                    </h4>
            ...
            <div class="card-body border-bottom py-3">
                <form method="GET" action="{{ route('material_requests.archived') }}" class="row g-2 align-items-end">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3 d-flex gap-1">
                        ...
                        @if ($search)
                            <a href="{{ route('material_requests.archived') }}" class="btn btn-outline-secondary btn-sm" title="Limpiar filtros">
