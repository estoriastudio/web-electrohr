...
<div class="card">
	...
	<div class="table-responsive">
		<table class="table table-hover align-middle mb-0">
			<thead class="bg-light-subtle"><tr><th>Cuadrilla</th><th>Obra</th><th class="text-center">Asignados</th><th class="text-center">Show</th><th class="text-center">No show</th><th class="text-center">Pendientes</th><th class="text-end">Acción</th></tr></thead>
			<tbody>
				...
				@empty
					<tr><td colspan="7" class="text-center text-muted py-4">No hay cuadrillas registradas.</td></tr>
				@endforelse
			</tbody>
		</table>
	</div>
